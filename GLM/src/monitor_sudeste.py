...
file = open('/home/cendas/GOES16_WS_Rodrigo/GLM/Output/Sudeste/G16_Log.txt', 'a')
file.close()
# Put all file names on the log in a list
logRJ = []
with open('/home/cendas/GOES16_WS_Rodrigo/GLM/Output/Sudeste/G16_Log.txt') as file:
...
# If a file is not on the log, process it
 if x not in logRJ:
  os.system("/home/cendas/miniconda3/envs/DataEnv/bin/python3 " + "\"/home/cendas/GOES16_WS_Rodrigo/GLM/src/Glm_sudeste.py\"" + " " + "\"" + x.replace('\\','\\\\') + "\"")
