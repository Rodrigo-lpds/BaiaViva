#!/bin/bash
export WORK='/home/cendas/GOES16_WS_Rodrigo/Samples/GLM_Samples/'
...
aws s3 --no-sign-request ls --recursive noaa-goes16/$PRODUCT/$YEAR/$DAY/$HOUR | awk '{print $3";"$4}' >> DesiredData.txt
# aws s3 ls --no-sign-request s3://noaa-goes16/GLM-L2-LCFA/2020/303/18/
done
done
done
done
