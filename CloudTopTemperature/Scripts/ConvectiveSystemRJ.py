...
if minute == 0:
  ...
  plt.savefig('/home/cendas/GOES16_WS_Rodrigo/CloudTopTemperature/Output/RJ/ConvectiveSystem/'+fileName+'.jpg', dpi=DPI, pad_inches=0,bbox_inches='tight', transparent=True)
  plt.close()
