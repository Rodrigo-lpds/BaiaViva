...
driver.CreateCopy('/home/cendas/GOES16_WS_Rodrigo/Geotiff/RegiaoNorteFluminense/sistconvectivos_RegiaoNorteFluminense'+str(Start)+'.tif', grid, 0)
...
with open('/home/cendas/GOES16_WS_Rodrigo/Geotiff/RegiaoNorteFluminense/G16_Log.txt', 'a') as log:
