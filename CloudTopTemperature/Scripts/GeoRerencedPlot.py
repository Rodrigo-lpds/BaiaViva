...
#if minute == 0:
#  plt.savefig('/home/cendas/GOES16_WS_Rodrigo/CloudTopTemperature/Output/RJ/ConvectiveSystem/sistconvectivos_rj'+ '_' + str(year) + str(month) + str(day) + '_' + hora + minutoZero+ '.jpg', dpi=DPI, pad_inches=0,bbox_inches='tight', transparent=True)
#  plt.close()
#  with open('/home/cendas/GOES16_WS_Rodrigo/CloudTopTemperature/Output/RJ/ConvectiveSystem/Lista_JPG.txt', 'a') as log:
#    log.write('sistconvectivos_rj'+ '_' + str(year) + str(month) + str(day) + '_' + hora + minutoZero+ '.jpg' + '\n')

#elif minute == 30:
#  plt.savefig('/home/cendas/GOES16_WS_Rodrigo/CloudTopTemperature/Output/RJ/ConvectiveSystem/sistconvectivos_rj'+ '_' + str(year) + str(month) + str(day) + '_' + hora + str(minute)+ '.jpg',# dpi=DPI, pad_inches=0,bbox_inches='tight', transparent=True)
#  plt.close()
#  with open('/home/cendas/GOES16_WS_Rodrigo/CloudTopTemperature/Output/RJ/ConvectiveSystem/Lista_JPG.txt', 'a') as log:
...
#with open('/home/cendas/GOES16_WS_Rodrigo/CloudTopTemperature/Output/RJ/ConvectiveSystem/G16_Log.txt', 'a') as log:
# log.write(path.replace('\\\\', '\\') + '\n')
#======================================================================================================

# Export the result to GeoTIFF
driver = gdal.GetDriverByName('GTiff')
driver.CreateCopy('/home/cendas/GOES16_WS_Rodrigo/CloudTopTemperature/Output/RJ/ProjectionsGEOTIF/CH13/Channel_13.tif', grid, 0)
#======================================================================================================
