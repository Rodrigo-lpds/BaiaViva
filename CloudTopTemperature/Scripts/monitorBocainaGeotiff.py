...
file = open('/home/cendas/GOES16_WS_Rodrigo/Geotiff/Bocaina/G16_Log.txt', 'a')
file.close()


# Put all file names on the log in a list
logRJ = []
with open('/home/cendas/GOES16_WS_Rodrigo/Geotiff/Bocaina/G16_Log.txt') as file:
...
for x in G16_images:
 ...
 if x not in logRJ:
  os.system("/home/cendas/miniconda3/envs/DataEnv/bin/python3 " + "\"/home/cendas/GOES16_WS_Rodrigo/CloudTopTemperature/Scripts/BocainaGeotiff.py\"" + " " + "\"" + x.replace('\\','\\\\') + "\"")