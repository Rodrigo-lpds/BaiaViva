...
file = open('/home/cendas/GOES16_WS_Rodrigo/CloudTopTemperature/Output/RJ/ConvectiveSystem/G16_Log.txt', 'a')
file.close()
# Put all file names on the log in a list
#convective system
logConvectiveSys = []
with open('/home/cendas/GOES16_WS_Rodrigo/CloudTopTemperature/Output/RJ/ConvectiveSystem/G16_Log.txt') as file:
...
for x in G16_files:
 ...
 if x not in logConvectiveSys:
  os.system("/home/cendas/miniconda3/envs/DataEnv/bin/python3 " + "\"/home/cendas/GOES16_WS_Rodrigo/CloudTopTemperature/Scripts/ConvectiveSystemRJ.py\"" + " " + "\"" + x.replace('\\','\\\\') + "\"")
