...
plt.savefig('/home/cendas/GOES16_WS_Rodrigo/CloudTopTemperature/Output/South_America/Projections/CH'+ str(Band) +'/SA_G16_C' + str(Band) + '_' + date + '_' + time_saved + '_UTC.png', dpi=DPI, pad_inches=0,bbox_inches='tight', transparent=True)
plt.close()
