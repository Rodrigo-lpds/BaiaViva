...
plt.text(extent[2] + lon_difference * 0.2, extent[1] + lat_difference * 0.5 ,ColorBarLabel, verticalalignment ='center', rotation = "vertical", color = 'black', size=9)
...
plt.figimage(logo_Lamce,  720, 10, zorder=3, alpha = 1, origin = 'upper') 
...
if minute == 0:
  ...
  plt.savefig('/home/cendas/GOES16_WS_Rodrigo/CloudTopTemperature/Output/RegiaoNorteFluminense/'+fileName+'.jpg', dpi=DPI, pad_inches=0,bbox_inches='tight', transparent=True)
  plt.close()
  with open('/home/cendas/GOES16_WS_Rodrigo/CloudTopTemperature/Output/RegiaoNorteFluminense/Lista_JPG.txt', 'a') as log:
...
with open('/home/cendas/GOES16_WS_Rodrigo/CloudTopTemperature/Output/RegiaoNorteFluminense/G16_Log.txt', 'a') as log:
