...
degrees = 0
# Choose the visualization extent (min lon, min lat, max lon, max lat)
extent = [-46 - degrees ,-26 - degrees,-40+ degrees,-19 + degrees] #Regiao MetroSerra
...
plt.text(extent[0] + lon_difference * 0.5, extent[3] + lat_difference * 0.035,Title, horizontalalignment='center', color = 'black', size=8.5)
plt.text(extent[0] + lon_difference * 0.5, extent[3] + lat_difference * 0.065," ", horizontalalignment='center', color = 'black', size=10)
plt.text(extent[0] + lon_difference * 0.5, extent[1] - lat_difference * 0.075,Longitude, horizontalalignment='center',color = 'black', size=10)
...
plt.text(extent[2] + lon_difference * 0.2, extent[1] + lat_difference * 0.5 ,ColorBarLabel, verticalalignment ='center', rotation = "vertical", color = 'black', size=10)
...
if minute == 0:
  ...
  plt.savefig('/home/cendas/GOES16_WS_Rodrigo/CloudTopTemperature/Output/RegiaoSerraMetro/'+fileName+'.jpg', dpi=DPI, pad_inches=0,bbox_inches='tight', transparent=True)
  plt.close()
  with open('/home/cendas/GOES16_WS_Rodrigo/CloudTopTemperature/Output/RegiaoSerraMetro/Lista_JPG.txt', 'a') as log:
...
with open('/home/cendas/GOES16_WS_Rodrigo/CloudTopTemperature/Output/RegiaoSerraMetro/G16_Log.txt', 'a') as log:
